...
func (a *Api) List() (status int, response interface{}) {
	...
	httpStatus, walletTransactions, err := wallet_transaction_list_service.NewService(a.db).List()
	if err != nil {
	...
	return httpStatus, json.Response{Data: fiber.Map{"wallet_transactions": walletTransactions}}
}
