		...
		Fields: graphql.Fields{
			"wallet_token": &graphql.Field{
				...
				Resolve: func(p graphql.ResolveParams) (interface{}, error) {
					...
					var err error
					_, walletToken, err = wallet_token_get_service.NewService(s.database, walletId, tokenId).Get()
					if err != nil {
						return nil, err
					}
			...
			"wallet_tokens": &graphql.Field{
				...
				Resolve: func(p graphql.ResolveParams) (interface{}, error) {
					...
					var err error
					_, walletTokens, err = wallet_token_list_service.NewService(s.database).List()
					if err != nil {
						return nil, err
					}
