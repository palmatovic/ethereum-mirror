...
import (
	...
	"gorm.io/gorm"
	wallet_list_service "wallet-syncronizer/pkg/service/wallet/list"
...
func (a *Api) List() (status int, response interface{}) {
	...
	httpStatus, wallets, err := wallet_list_service.NewService(a.db).List()
	if err != nil {
	...
	return httpStatus, json.Response{Data: fiber.Map{"wallets": wallets}}
}
