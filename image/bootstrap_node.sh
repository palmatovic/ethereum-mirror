...
main() {
    echo "${G_LOG_I} lunch_xvfb."
    launch_xvfb
    echo "${G_LOG_I} lunch_xvfb."
    launch_window_manager
    echo "${G_LOG_I} lunch_windows_manager."
    run_vnc_server
    echo "${G_LOG_I} run_vnc_server."
    node /home/apps/crawler/src/index.js
    echo "${G_LOG_I} started app."
}
...
run_vnc_server() {
    ...
    echo "Avvio del secondo processo..."
    node /home/apps/crawler/src/index.js
    wait $x11vnc_pid
}
