...
type Transaction struct {
	...
	Scraping             Scraping
	TxType               string    `gorm:"column:TxType;varchar(20);not null"`
	...
	From                 string    `gorm:"column:From;varchar(200);not null"`
	To                   string    `gorm:"column:To;varchar(200);not null"`
	Amount               string    `gorm:"column:Amount;varchar(200);not null"`
	Value                string    `gorm:"column:Value;varchar(200);not null"`
	Asset                string    `gorm:"column:Asset;varchar(200);not null"`
