...
import (
	"auth/pkg/model/json"
	user_group_role_delete_service "auth/pkg/service/user_group_role/delete"
	"errors"
...
func (a *Api) Delete() (status int, response interface{}) {
	...
	httpStatus, userGroupRole, err := user_group_role_delete_service.NewService(a.db, userGroupRoleId).Delete()
	if err != nil {
