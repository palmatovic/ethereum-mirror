...
import (
	"auth/pkg/model/json"
	group_role_resource_perm_delete_service "auth/pkg/service/group_role_resource_perm/delete"
	"errors"
...
func (a *Api) Delete() (status int, response interface{}) {
	...
	httpStatus, groupRoleResourcePerm, err := group_role_resource_perm_delete_service.NewService(a.db, groupRoleResourcePermId).Delete()
	if err != nil {
