...
import (
	"auth/pkg/model/json"
	user_product_delete_service "auth/pkg/service/user_product/delete"
	"errors"
...
func (a *Api) Delete() (status int, response interface{}) {
	...
	httpStatus, userProduct, err := user_product_delete_service.NewService(a.db, userProductId).Delete()
	if err != nil {
