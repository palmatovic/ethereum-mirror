...
type GroupRoleResourcePerm struct {
	...
	GroupRoleId             int64 `json:"group_role_id" gorm:"column:GroupRoleId;uniqueIndex:GroupRoleResourcePermIdx"`
	group_role.GroupRole
	ResourcePermId int64 `json:"resource_perm_id" gorm:"column:ResourcePermId;uniqueIndex:GroupRoleResourcePermIdx"`
